...
\section{Convolutional Neural Network Method} % (fold)
	...
	\subsection{Discussion} % (fold)
		...
		I know from looking at the code examples for larger networks, designed for the ImageNet and Cifar databases\fxnote{reference}, that this is possible, but I have not had time within the scope of this project to figure out how this would work this toolbox.
