...
nTargets = size(targetLabel,2); % Include pain
nSubjects = 25;
...
for facsLabelIdx = 11 % Only test pain
...
for targetIdx = 11 % Only test pain
...
% save('data\compareSVMresultsPainAllBalanced.mat');
