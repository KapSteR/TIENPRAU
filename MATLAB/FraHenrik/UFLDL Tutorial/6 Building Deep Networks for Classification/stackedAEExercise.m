...
% disp(1000*[numgrad(1:10) grad(1:10) (numgrad(1:10)-grad(1:10))]); 
% disp(1000*[numgrad grad (numgrad-grad)]); 
% % disp(1000*[numgrad(end-100:end) grad(end-100:end) (numgrad(end-100:end)-grad(end-100:end))]); 
% % 
